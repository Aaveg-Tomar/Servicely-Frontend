                            ...
                            <div key={index} className="flex justify-center my-5 mx-5">
                                <div className="relative flex-col items-center shadow-2xl rounded-[20px] px-2">
                                    <div className="relative flex h-32 w-full justify-center rounded-xl bg-cover">
                                        <img src="https://thumbs.dreamstime.com/b/home-service-repair-construction-fix-house-background-home-service-repair-construction-fix-house-background-155882678.jpg" className="absolute flex h-32 w-full justify-center rounded-xl bg-cover" alt="background" />
                                        <div className="absolute -bottom-12 flex h-[87px] w-[87px] items-center justify-center rounded-full border-[4px] border-white ">
                                            <img className="h-full w-full rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiwVJV38db9e6c6qLcHw53zMFT9j81nnv13Go8rzlOSA&s" alt="providerimage" />
                                        </div>
                                    </div>
